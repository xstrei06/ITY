...
\-\hspace{12pt} Čím více \textit{druhů}, \textbf{řezů}, {\huge velikostí}, \textcolor{blue}{barev} písma a jiných \textsc{\textcolor{red}{efektů}} \underline{použijeme}, tím \textcolor{orange(colorwheel)}{profesio\-nálněji} bude {\fontfamily{pzc}\selectfont \Large{dokument}} vypadat. {\tiny Čtenář} tím bude vždy {\Huge \textbf{nadšen!}}
\end{adjustwidth}
\smallskip
...
Balíček {\fontfamily{cmtt}\selectfont fontenc} slouží ke korektnímu kódovaní znaků s~diakritikou, aby bylo možno v textu vyhledávat a~kopí\-rovat z~něj.
